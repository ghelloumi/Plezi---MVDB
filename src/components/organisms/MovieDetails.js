...
const MovieDetails = ({ movieId }) => {
  const { pending, movieDetailsRes, error } = useSelector(
      ...
      <div className="movie__details">
          ...
          <>
              <div className="movie__details__main">
                  ...
                  src={ formatImageLink(
                    movieDetailsRes.poster_path,
                    transformations.MOVIES_POSTER
                  ) }
                />
                      </a>
                  </div>
                  <div className="main__details">
                      <span>
                          {movieDetailsRes.status}: {movieDetailsRes.release_date}
                      </span>
                      <span>
                          {TEXTS.VOTE_AVERAGE}: {movieDetailsRes.vote_average}
                      </span>
                      <div className="main__details__productionCountries">
                          {movieDetailsRes.production_countries &&
                  movieDetailsRes.production_countries.map((e) => (
                      <Image
                      key={ e.iso_3166_1 }
                      alt={ ALTS.PROD_COUNTRY_FLAG_ALT }
              ...
              <div className="movie__details__content">
                  ...
                  <div>
                      ...
                      <div>
                          {movieDetailsRes.production_companies &&
                  movieDetailsRes.production_companies.map((e) => (
                      <Image
                      key={ e.id }
                      src={ formatImageLink(
                        e.logo_path,
                        transformations.PROD_COMPANIES
                      ) }
